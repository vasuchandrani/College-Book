...
/**
 * Shared HTML email template generator for CollegeBook.
 */
public final class EmailTemplates {
    ...
    public static String buildPasswordResetEmailHtml(String frontendUrl, String resetToken) {
    ...
    public static String buildPasswordChangeOtpEmailHtml(String otpCode) {
        return "<!DOCTYPE html>" +
                "<html>" +
                "<head><meta charset='UTF-8'></head>" +
                "<body style='margin:0; padding:0; background-color:#f4f6f9; font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif;'>" +
    ...
    public static String buildMemoryBookOtpEmailHtml(String otpCode) {
        return "<!DOCTYPE html>" +
                "<html>" +
                "<head><meta charset='UTF-8'></head>" +
                "<body style='margin:0; padding:0; background-color:#f4f6f9; font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif;'>" +
