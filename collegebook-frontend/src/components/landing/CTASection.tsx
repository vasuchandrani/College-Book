    ...
    <section className="py-12 sm:py-20 md:py-28 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-2xl sm:rounded-3xl bg-gradient-hero p-6 sm:p-12 md:p-16 text-center overflow-hidden shadow-elevated border border-primary/20"
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-4 sm:space-y-6">
            ...
            <p className="text-primary-foreground/80 text-xs sm:text-base md:text-lg leading-relaxed">
